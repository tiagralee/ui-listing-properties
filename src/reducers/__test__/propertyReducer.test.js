...
describe('propertyReducer', () => {
    it('should handle SAVE_PROPERTY to save a property', () => {
        const savePropertyAction = {
        ...
        expect(propertyReducer(testInitialState, savePropertyAction)).toEqual(expected);
    })

    it('should handle REMOVE_PROPERTY to remove a property', () => {
        ...
        expect(propertyReducer(testInitialState, removePropertyAction)).toEqual(expected);
    })
})